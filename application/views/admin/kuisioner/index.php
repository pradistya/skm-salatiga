...
<section class="section">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php }?>
            <a href="<?php echo base_url(); ?>kuisioner/tambah" class="btn btn-primary">Tambah Data Baru</a>
                ...
                <tbody>
                    <?php $no=1; foreach ($pertanyaan as $key) { ?>
                        <tr>
                            ...
                            <td>
                                    <a href="<?php echo base_url(); ?>kuisioner/edit/<?php echo $key->id_pertanyaan; ?>" class="btn btn-sm btn-warning">
                                    ...
                                    <a href="<?php echo base_url(); ?>kuisioner/delete/<?php echo $key->id_pertanyaan; ?>" class="btn btn-sm btn-danger">
                                        <svg class="bi" width="1em" height="1em" fill="currentColor">
                                            <use
