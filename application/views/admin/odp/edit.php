        ...
        <div class="col-md-8 mx-auto mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php }?>
                    <form class="form form-vertical" method="post" action="<?= base_url('odp/update');?>">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        placeholder="Masukkan nama OPD" value="<?php echo $odp->opd_nama; ?>">
                                        <input type="hidden" name="id" value="<?php echo $odp->id_opd; ?>">
                                    </div>
                                </div>
